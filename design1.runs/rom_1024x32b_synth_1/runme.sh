...
HD_PWD='F:/Code/Other/vivado/cource_design/design1/design1.runs/rom_1024x32b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_1024x32b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_1024x32b.tcl
